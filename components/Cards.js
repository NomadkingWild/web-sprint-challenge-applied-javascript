...
.then(response=>{
    ...
    values.forEach(items=>{
        for(let object of items){
            card.appendChild(articleMaker(object));
        }
    })
})
...
card.appendChild(imageCon)
imageCon.appendChild(image)
imageCon.appendChild(authorName)


card.className = "card"
headline.className = "headline"
author.className = "author"
imageCon.className = "img-container"
...
// cards.appendChild(articleMaker(articleObj))
